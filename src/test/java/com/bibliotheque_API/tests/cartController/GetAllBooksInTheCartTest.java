...
public class GetAllBooksInTheCartTest extends TestBase_API {
...
//                .header(AUTH, UserData.validEmail)
    ...
    @Test
    public void getAllBooksInUsersCartApiSuccessTest() {

        given()
                .header(AUTH, UserData.validEmail)
                .contentType("application/json")
                .get(EndpointData.getAllBooksInTheCart + id)
                .then()
...
////                .header(AUTH, UserData.validEmail)
//                .contentType("application/json")
//                .delete(EndpointData.deleteBookFromCart + bookId);
